...
Ralph is an autonomous AI agent loop that runs Claude repeatedly until all PRD items are complete. Each iteration is a fresh Claude instance with clean context. Memory persists via git history, `progress.txt`, and `prd.json`.
...
### Configure Amp auto-handoff (recommended) (claude does not have this)
